...
export default class {
  ...
  get template() {
    return `<article class="card card--${this._color} ${ this._repeatingDays.isRepeat ? `card--repeat` : ``}">
    <form class="card__form" method="get">
      <div class="card__inner">
        ...
        <div class="card__color-bar">
          <svg class="${this._repeatingDays.isRepeat ? `card__color-bar-wave` : ``}" width="100%" height="10">
  ...
  bind() {
    this._element.querySelector(`.card__btn--edit`).addEventListener(`click`, this._onEdit.bind(this));
  }
